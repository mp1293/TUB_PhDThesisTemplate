...
\documentclass[twoside,11pt,online,a4paper,pdfa1,custommargin,biblatex]{Classes/PhDthesisTUB}
...
%
% `fontA' :  XITS - STIX Math
% `fontB': Cambria - Cambria Math
% 'fontC': Libertinus
% 'fontD': TeX Gyre Pagella - mathpazo
% 'fontE': TeX Gyre Pagella - Asana Math
%
% `customfont': Use `customfont' option in the document class and load the
% package in the preamble.tex
%
